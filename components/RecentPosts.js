            ...
            <div className="flex flex-wrap -m-12">
                ...
                {/* mapping components */}
                {
                    blogsFrontMatter.map((blog)=>{
                        ...
                        return(
                            <div key={blog.title} className="p-12 md:w-1/2 flex flex-col items-start dark:bg-pink-600">
                                <h2 className="sm:text-3xl text-2xl title-font font-medium text-white mt-4 mb-4">{title}</h2>
